...
printf "@print hello\nexit\n" | ./busybox_shell | grep "AI suggestion: echo hello"
printf "@help of ls\nexit\n" | ./busybox_shell | grep "AI suggestion: help ls"
printf "@what does mkdir do\nexit\n" | ./busybox_shell | grep "AI suggestion: help mkdir"
printf "@count words in Makefile\nexit\n" | ./busybox_shell | grep "AI suggestion: wc Makefile"
printf "@show first lines of Makefile\nexit\n" | ./busybox_shell | grep "AI suggestion: head Makefile"
printf "@show last lines of Makefile\nexit\n" | ./busybox_shell | grep "AI suggestion: tail Makefile"
printf "@list file names in json format\nexit\n" | ./busybox_shell | grep "AI suggestion: ls --json"
printf "@list files in reverse order\nexit\n" | ./busybox_shell | grep "AI suggestion: ls -r"
printf "@list hidden files with details\nexit\n" | ./busybox_shell | grep "AI suggestion: ls -a -l"
